...
/*
* Now we add a memoization cache.
*
* We create a function that "smells like" (same signature) as our
* provider. All it does is save the values and return them
* instead of calling the provider function again.
*
* No other changes. See how the main function had only one change,
* and that was on initialization.
*
* EXAMINE THE OUTPUT!!!! WHAT'S WRONG HERE!
*
* Even though we have a cache, factorial() is still getting called
* a fair amount!
*
* Why is this? DO NOT MOVE TO 4 until you have a theory.
*/
...
int main(int argc, char *argv[]) {
    ...
    long_func_ptr factorial_provider = init_cache(factorial);
